...
const UUID = process.env.UUID || '69c5924f-df14-4ee0-899e-a1704de92870'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖           
const DOMAIN = process.env.DOMAIN || 'ss.tvop.de5.net';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
